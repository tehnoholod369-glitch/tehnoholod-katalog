...
(function () {
  ...
  function build() {
    ...
    bar.innerHTML =
      ...
      + '<a href="Каталог - выдача.dc.html" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:9px 4px;color:#0A4EA7;font-size:12px;font-weight:600;text-decoration:none">'
