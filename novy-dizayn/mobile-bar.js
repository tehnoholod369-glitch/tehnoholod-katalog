...
(function () {
  ...
  function build() {
    ...
    bar.innerHTML =
      '<a href="tel:+77000369369" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:9px 4px;color:#0A4EA7;font-size:11px;font-weight:600;text-decoration:none">'
      ...
      + '<a href="https://wa.me/77000369369" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:9px 4px;color:#0B6B45;font-size:11px;font-weight:600;text-decoration:none">'
      ...
      + '<a href="Каталог - выдача.dc.html" style="display:flex;flex-direction:column;align-items:center;gap:3px;padding:9px 4px;color:#0A4EA7;font-size:11px;font-weight:600;text-decoration:none">'
