  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap"></div>' +
        '    <div class="sub">или <u>выберите файл</u></div></div>' +
        '  <div class="attr-error" part="attribution-error">' + warnIcon +
        '    <div class="cap">Фото требует указания автора</div></div>' +
        ...
        '<div class="ctl" popover="manual" data-dc-edit-transparent><button data-act="replace" title="Заменить фото">Заменить</button>' +
        '  <button data-act="edit" title="Кадрировать фото">Кадрировать</button></div>' +
